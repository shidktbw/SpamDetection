...
tokenizer.fit_on_texts(df['v2']) # change 'message' to 'v2'
sequences = tokenizer.texts_to_sequences(df['v2']) # change 'message' to 'v2'
padded = pad_sequences(sequences, padding='post')

# Change 'label' to 'v1' and make sure it is encoded properly (1 for spam and 0 for ham)
